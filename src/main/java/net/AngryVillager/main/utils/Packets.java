package net.AngryVillager.main.utils;
	...
	public void changeChestState(Location loc, boolean open)
	  {
	    ...
	    for (Player player : Bukkit.getOnlinePlayers())
	    {
	      ...
	      PacketPlayOutBlockAction blockActionPacket = new PacketPlayOutBlockAction(position, net.minecraft.server.v1_11_R1.Block.getById(loc.getBlock().getTypeId()), 1, dataByte);
